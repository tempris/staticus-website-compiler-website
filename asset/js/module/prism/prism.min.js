 ...
 * @namespace
 * @public
 */void 0!==module&&module.exports&&(module.exports=Prism),void 0!==global&&(global.Prism=Prism),Prism.languages.markup={comment:{pattern:/<!--(?:(?!<!--)[\s\S])*?-->/,greedy:!0},prolog:{pattern:/<\?[\s\S]+?\?>/,greedy:!0},doctype:{pattern:/<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,greedy:!0,inside:{"internal-subset":{pattern:/(^[^\[]*\[)[\s\S]+(?=\]>$)/,lookbehind:!0,greedy:!0,inside:null},string:{pattern:/"[^"]*"|'[^']*'/,greedy:!0},punctuation:/^<!|>$|[[\]]/,"doctype-tag":/^DOCTYPE/i,name:/[^\s<>'"]+/}},cdata:{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,greedy:!0},tag:{pattern:/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/,greedy:!0,inside:{tag:{pattern:/^<\/?[^\s>\/]+/,inside:{punctuation:/^<\/?/,namespace:/^[^\s>\/:]+:/}},"special-attr":[],"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{punctuation:[{pattern:/^=/,alias:"attr-equals"},{pattern:/^(\s*)["']|["']$/,lookbehind:!0}]}},punctuation:/\/?>/,"attr-name":{pattern:/[^\s>\/]+/,inside:{namespace:/^[^\s>\/:]+:/}}}},entity:[{pattern:/&[\da-z]{1,8};/i,alias:"named-entity"},/&#x?[\da-f]{1,8};/i]},Prism.languages.markup.tag.inside["attr-value"].inside.entity=Prism.languages.markup.entity,Prism.languages.markup.doctype.inside["internal-subset"].inside=Prism.languages.markup,Prism.hooks.add("wrap",function(env){"entity"===env.type&&(env.attributes.title=env.content.replace(/&amp;/,"&"))}),Object.defineProperty(Prism.languages.markup.tag,"addInlined",{value:function(tagName,lang){var includedCdataInside={};includedCdataInside["language-"+lang]={pattern:/(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,lookbehind:!0,inside:Prism.languages[lang]},includedCdataInside.cdata=/^<!\[CDATA\[|\]\]>$/i;var inside={"included-cdata":{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,inside:includedCdataInside}};inside["language-"+lang]={pattern:/[\s\S]+/,inside:Prism.languages[lang]};var def={};def[tagName]={pattern:RegExp(/(<__[^>]*>)(?:<!\[CDATA\[(?:[^\]]|\](?!\]>))*\]\]>|(?!<!\[CDATA\[)[\s\S])*?(?=<\/__>)/.source.replace(/__/g,function(){return tagName}),"i"),lookbehind:!0,greedy:!0,inside:inside},Prism.languages.insertBefore("markup","cdata",def)}}),Object.defineProperty(Prism.languages.markup.tag,"addAttribute",{value:function(attrName,lang){Prism.languages.markup.tag.inside["special-attr"].push({pattern:RegExp(/(^|["'\s])/.source+"(?:"+attrName+")"+/\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))/.source,"i"),lookbehind:!0,inside:{"attr-name":/^[^\s=]+/,"attr-value":{pattern:/=[\s\S]+/,inside:{value:{pattern:/(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/,lookbehind:!0,alias:[lang,"language-"+lang],inside:Prism.languages[lang]},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}}}})}}),Prism.languages.html=Prism.languages.markup,Prism.languages.mathml=Prism.languages.markup,Prism.languages.svg=Prism.languages.markup,Prism.languages.xml=Prism.languages.extend("markup",{}),Prism.languages.ssml=Prism.languages.xml,Prism.languages.atom=Prism.languages.xml,Prism.languages.rss=Prism.languages.xml,function(Prism){var string=/(?:"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"|'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n])*')/;Prism.languages.css={comment:/\/\*[\s\S]*?\*\//,atrule:{pattern:RegExp("@[\\w-](?:"+/[^;{\s"']|\s+(?!\s)/.source+"|"+string.source+")*?"+/(?:;|(?=\s*\{))/.source),inside:{rule:/^@[\w-]+/,"selector-function-argument":{pattern:/(\bselector\s*\(\s*(?![\s)]))(?:[^()\s]|\s+(?![\s)])|\((?:[^()]|\([^()]*\))*\))+(?=\s*\))/,lookbehind:!0,alias:"selector"},keyword:{pattern:/(^|[^\w-])(?:and|not|only|or)(?![\w-])/,lookbehind:!0}}},url:{pattern:RegExp("\\burl\\((?:"+string.source+"|"+/(?:[^\\\r\n()"']|\\[\s\S])*/.source+")\\)","i"),greedy:!0,inside:{function:/^url/i,punctuation:/^\(|\)$/,string:{pattern:RegExp("^"+string.source+"$"),alias:"url"}}},selector:{pattern:RegExp("(^|[{}\\s])[^{}\\s](?:[^{};\"'\\s]|\\s+(?![\\s{])|"+string.source+")*(?=\\s*\\{)"),lookbehind:!0},string:{pattern:string,greedy:!0},property:{pattern:/(^|[^-\w\xA0-\uFFFF])(?!\s)[-_a-z\xA0-\uFFFF](?:(?!\s)[-\w\xA0-\uFFFF])*(?=\s*:)/i,lookbehind:!0},important:/!important\b/i,function:{pattern:/(^|[^-a-z0-9])[-a-z0-9]+(?=\()/i,lookbehind:!0},punctuation:/[(){};:,]/},Prism.languages.css.atrule.inside.rest=Prism.languages.css;var markup=Prism.languages.markup;markup&&(markup.tag.addInlined("style","css"),markup.tag.addAttribute("style","css"))}(Prism),Prism.languages.clike={comment:[{pattern:/(^|[^\\])\/\*[\s\S]*?(?:\*\/|$)/,lookbehind:!0,greedy:!0},{pattern:/(^|[^\\:])\/\/.*/,lookbehind:!0,greedy:!0}],string:{pattern:/(["'])(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,greedy:!0},"class-name":{pattern:/(\b(?:class|extends|implements|instanceof|interface|new|trait)\s+|\bcatch\s+\()[\w.\\]+/i,lookbehind:!0,inside:{punctuation:/[.\\]/}},keyword:/\b(?:break|catch|continue|do|else|finally|for|function|if|in|instanceof|new|null|return|throw|try|while)\b/,boolean:/\b(?:false|true)\b/,function:/\b\w+(?=\()/,number:/\b0x[\da-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:e[+-]?\d+)?/i,operator:/[<>]=?|[!=]=?=?|--?|\+\+?|&&?|\|\|?|[?*/~^%]/,punctuation:/[{}[\];(),.:]/},Prism.languages.javascript=Prism.languages.extend("clike",{"class-name":[Prism.languages.clike["class-name"],{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$A-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\.(?:constructor|prototype))/,lookbehind:!0}],keyword:[{pattern:/((?:^|\})\s*)catch\b/,lookbehind:!0},{pattern:/(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/,lookbehind:!0}],function:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,number:{pattern:RegExp(/(^|[^\w$])/.source+"(?:"+/NaN|Infinity/.source+"|"+/0[bB][01]+(?:_[01]+)*n?/.source+"|"+/0[oO][0-7]+(?:_[0-7]+)*n?/.source+"|"+/0[xX][\dA-Fa-f]+(?:_[\dA-Fa-f]+)*n?/.source+"|"+/\d+(?:_\d+)*n/.source+"|"+/(?:\d+(?:_\d+)*(?:\.(?:\d+(?:_\d+)*)?)?|\.\d+(?:_\d+)*)(?:[Ee][+-]?\d+(?:_\d+)*)?/.source+")"+/(?![\w$])/.source),lookbehind:!0},operator:/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/}),Prism.languages.javascript["class-name"][0].pattern=/(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/,Prism.languages.insertBefore("javascript","keyword",{regex:{pattern:RegExp(/((?:^|[^$\w\xA0-\uFFFF."'\])\s]|\b(?:return|yield))\s*)/.source+/\//.source+"(?:"+/(?:\[(?:[^\]\\\r\n]|\\.)*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}/.source+"|"+/(?:\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.)*\])*\])*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}v[dgimyus]{0,7}/.source+")"+/(?=(?:\s|\/\*(?:[^*]|\*(?!\/))*\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/.source),lookbehind:!0,greedy:!0,inside:{"regex-source":{pattern:/^(\/)[\s\S]+(?=\/[a-z]*$)/,lookbehind:!0,alias:"language-regex",inside:Prism.languages.regex},"regex-delimiter":/^\/|\/$/,"regex-flags":/^[a-z]+$/}},"function-variable":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*[=:]\s*(?:async\s*)?(?:\bfunction\b|(?:\((?:[^()]|\([^()]*\))*\)|(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/,alias:"function"},parameter:[{pattern:/(function(?:\s+(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)?\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\))/,lookbehind:!0,inside:Prism.languages.javascript},{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=>)/i,lookbehind:!0,inside:Prism.languages.javascript},{pattern:/(\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*=>)/,lookbehind:!0,inside:Prism.languages.javascript},{pattern:/((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,lookbehind:!0,inside:Prism.languages.javascript}],constant:/\b[A-Z](?:[A-Z_]|\dx?)*\b/}),Prism.languages.insertBefore("javascript","string",{hashbang:{pattern:/^#!.*/,greedy:!0,alias:"comment"},"template-string":{pattern:/`(?:\\[\s\S]|\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}|(?!\$\{)[^\\`])*`/,greedy:!0,inside:{"template-punctuation":{pattern:/^`|`$/,alias:"string"},interpolation:{pattern:/((?:^|[^\\])(?:\\{2})*)\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/,lookbehind:!0,inside:{"interpolation-punctuation":{pattern:/^\$\{|\}$/,alias:"punctuation"},rest:Prism.languages.javascript}},string:/[\s\S]+/}},"string-property":{pattern:/((?:^|[,{])[ \t]*)(["'])(?:\\(?:\r\n|[\s\S])|(?!\2)[^\\\r\n])*\2(?=\s*:)/m,lookbehind:!0,greedy:!0,alias:"property"}}),Prism.languages.insertBefore("javascript","operator",{"literal-property":{pattern:/((?:^|[,{])[ \t]*)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*:)/m,lookbehind:!0,alias:"property"}}),Prism.languages.markup&&(Prism.languages.markup.tag.addInlined("script","javascript"),Prism.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source,"javascript")),Prism.languages.js=Prism.languages.javascript,function(){if(void 0!==Prism&&"undefined"!=typeof document){Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector);var EXTENSIONS={js:"javascript",py:"python",rb:"ruby",ps1:"powershell",psm1:"powershell",sh:"bash",bat:"batch",h:"c",tex:"latex"},SELECTOR='pre[data-src]:not([data-src-status="loaded"]):not([data-src-status="loading"])';Prism.hooks.add("before-highlightall",function(env){env.selector+=", "+SELECTOR}),Prism.hooks.add("before-sanity-check",function(env){var pre=env.element;if(pre.matches(SELECTOR)){env.code="",pre.setAttribute("data-src-status","loading");var code=pre.appendChild(document.createElement("CODE"));code.textContent="Loading…";var src=pre.getAttribute("data-src"),language=env.language;if("none"===language){var extension=(/\.(\w+)$/.exec(src)||[,"none"])[1];language=EXTENSIONS[extension]||extension}Prism.util.setLanguage(code,language),Prism.util.setLanguage(pre,language);var autoloader=Prism.plugins.autoloader;autoloader&&autoloader.loadLanguages(language),function(src,success,error){var xhr=new XMLHttpRequest;xhr.open("GET",src,!0),xhr.onreadystatechange=function(){4==xhr.readyState&&(xhr.status<400&&xhr.responseText?success(xhr.responseText):xhr.status>=400?error("✖ Error "+xhr.status+" while fetching file: "+xhr.statusText):error("✖ Error: File does not exist or is empty"))},xhr.send(null)}(src,function(text){pre.setAttribute("data-src-status","loaded");var range=function(range){var m=/^\s*(\d+)\s*(?:(,)\s*(?:(\d+)\s*)?)?$/.exec(range||"");if(m){var start=Number(m[1]),comma=m[2],end=m[3];return comma?end?[start,Number(end)]:[start,void 0]:[start,start]}}(pre.getAttribute("data-range"));if(range){var lines=text.split(/\r\n?|\n/g),start=range[0],end=null==range[1]?lines.length:range[1];start<0&&(start+=lines.length),start=Math.max(0,Math.min(start-1,lines.length)),end<0&&(end+=lines.length),end=Math.max(0,Math.min(end,lines.length)),text=lines.slice(start,end).join("\n"),pre.hasAttribute("data-start")||pre.setAttribute("data-start",String(start+1))}code.textContent=text,Prism.highlightElement(code)},function(error){pre.setAttribute("data-src-status","failed"),code.textContent=error})}}),Prism.plugins.fileHighlight={highlight:function(container){for(var element,elements=(container||document).querySelectorAll(SELECTOR),i=0;element=elements[i++];)Prism.highlightElement(element)}};var logged=!1;Prism.fileHighlight=function(){logged||(console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),logged=!0),Prism.plugins.fileHighlight.highlight.apply(this,arguments)}}}()}).call(this)}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}],12:[function(require,module,exports){"use strict";!function(){if("undefined"!=typeof Prism){var url=/\b([a-z]{3,7}:\/\/|tel:)[\w\-+%~/.:=&!$'()*,;@]+(?:\?[\w\-+%~/.:=?&!$'()*,;@]*)?(?:#[\w\-+%~/.:#=?&!$'()*,;@]*)?/,email=/\b\S+@[\w.]+[a-z]{2}/,linkMd=/\[([^\]]+)\]\(([^)]+)\)/,candidates=["comment","url","attr-value","string"];Prism.plugins.autolinker={processGrammar:function(grammar){grammar&&!grammar["url-link"]&&(Prism.languages.DFS(grammar,function(key,def,type){if(candidates.indexOf(type)>-1&&!Array.isArray(def)){if(def=function(container,key,def){return null==def||Array.isArray(def)?null:(def instanceof RegExp&&(def=container[key]={pattern:def}),"Object"!==Prism.util.type(def)?null:def.pattern&&"function"==typeof def.pattern.exec?(def.inside=def.inside||{},def):null)}(this,key,def),!def)return;"comment"==type&&(def.inside["md-link"]=linkMd),"attr-value"==type?Prism.languages.insertBefore("inside","punctuation",{"url-link":url},def):def.inside["url-link"]=url,def.inside["email-link"]=email}}),grammar["url-link"]=url,grammar["email-link"]=email)}},Prism.hooks.add("before-highlight",function(env){Prism.plugins.autolinker.processGrammar(env.grammar)}),Prism.hooks.add("wrap",function(env){if(/-link$/.test(env.type)){env.tag="a";var href=env.content;if("email-link"==env.type&&0!=href.indexOf("mailto:"))href="mailto:"+href;else if("md-link"==env.type){var match=env.content.match(linkMd);href=match[2],env.content=match[1]}env.attributes.href=href;try{env.content=decodeURIComponent(env.content)}catch(e){}}})}}()},{}],13:[function(require,module,exports){"use strict";!function(){function registerClipboard(element,copyInfo){element.addEventListener("click",function(){!function(copyInfo){navigator.clipboard?navigator.clipboard.writeText(copyInfo.getText()).then(copyInfo.success,function(){fallbackCopyTextToClipboard(copyInfo)}):fallbackCopyTextToClipboard(copyInfo)}(copyInfo)})}function fallbackCopyTextToClipboard(copyInfo){var textArea=document.createElement("textarea");textArea.value=copyInfo.getText(),textArea.style.top="0",textArea.style.left="0",textArea.style.position="fixed",document.body.appendChild(textArea),textArea.focus(),textArea.select();try{var successful=document.execCommand("copy");setTimeout(function(){successful?copyInfo.success():copyInfo.error()},1)}catch(err){setTimeout(function(){copyInfo.error(err)},1)}document.body.removeChild(textArea)}"undefined"!=typeof Prism&&"undefined"!=typeof document&&(Prism.plugins.toolbar?Prism.plugins.toolbar.registerButton("copy-to-clipboard",function(env){var element=env.element,settings=function(startElement){var settings={copy:"Copy","copy-error":"Press Ctrl+C to copy","copy-success":"Copied!","copy-timeout":5e3};for(var key in settings){for(var attr="data-prismjs-"+key,element=startElement;element&&!element.hasAttribute(attr);)element=element.parentElement;element&&(settings[key]=element.getAttribute(attr))}return settings}(element),linkCopy=document.createElement("button");linkCopy.className="copy-to-clipboard-button",linkCopy.setAttribute("type","button");var linkSpan=document.createElement("span");return linkCopy.appendChild(linkSpan),setState("copy"),registerClipboard(linkCopy,{getText:function(){return element.textContent},success:function(){setState("copy-success"),resetText()},error:function(){setState("copy-error"),setTimeout(function(){!function(element){window.getSelection().selectAllChildren(element)}(element)},1),resetText()}}),linkCopy;function resetText(){setTimeout(function(){setState("copy")},settings["copy-timeout"])}function setState(state){linkSpan.textContent=settings[state],linkCopy.setAttribute("data-copy-state",state)}}):console.warn("Copy to Clipboard plugin loaded before Toolbar plugin."))}()},{}],14:[function(require,module,exports){"use strict";!function(){if("undefined"!=typeof Prism){var autoLinkerProcess=function(grammar){return Prism.plugins.autolinker&&Prism.plugins.autolinker.processGrammar(grammar),grammar},dataURI={pattern:/(.)\bdata:[^\/]+\/[^,]+,(?:(?!\1)[\s\S]|\\\1)+(?=\1)/,lookbehind:!0,inside:{"language-css":{pattern:/(data:[^\/]+\/(?:[^+,]+\+)?css,)[\s\S]+/,lookbehind:!0},"language-javascript":{pattern:/(data:[^\/]+\/(?:[^+,]+\+)?javascript,)[\s\S]+/,lookbehind:!0},"language-json":{pattern:/(data:[^\/]+\/(?:[^+,]+\+)?json,)[\s\S]+/,lookbehind:!0},"language-markup":{pattern:/(data:[^\/]+\/(?:[^+,]+\+)?(?:html|xml),)[\s\S]+/,lookbehind:!0}}},candidates=["url","attr-value","string"];Prism.plugins.dataURIHighlight={processGrammar:function(grammar){grammar&&!grammar["data-uri"]&&(Prism.languages.DFS(grammar,function(key,def,type){if(candidates.indexOf(type)>-1&&!Array.isArray(def)){if(def=function(container,key,def){return null==def||Array.isArray(def)?null:(def instanceof RegExp&&(def=container[key]={pattern:def}),"Object"!==Prism.util.type(def)?null:def.pattern&&"function"==typeof def.pattern.exec?(def.inside=def.inside||{},def):null)}(this,key,def),!def)return;"attr-value"==type?Prism.languages.insertBefore("inside",def.inside["url-link"]?"url-link":"punctuation",{"data-uri":dataURI},def):def.inside["url-link"]?Prism.languages.insertBefore("inside","url-link",{"data-uri":dataURI},def):def.inside["data-uri"]=dataURI}}),grammar["data-uri"]=dataURI)}},Prism.hooks.add("before-highlight",function(env){if(dataURI.pattern.test(env.code))for(var p in dataURI.inside)if(dataURI.inside.hasOwnProperty(p)){var languageToken=dataURI.inside[p];if(languageToken&&languageToken.pattern&&!languageToken.inside&&languageToken.pattern.test(env.code)){var lang=p.match(/^language-(.+)/)[1];Prism.languages[lang]&&(languageToken.inside={rest:autoLinkerProcess(Prism.languages[lang])})}}Prism.plugins.dataURIHighlight.processGrammar(env.grammar)})}}()},{}],15:[function(require,module,exports){"use strict";!function(){if("undefined"!=typeof Prism&&"undefined"!=typeof document){var HTML_TAG=/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/g,HEX_COLOR=/^#?((?:[\da-f]){3,4}|(?:[\da-f]{2}){3,4})$/i,parsers=[function(hex){var match=HEX_COLOR.exec(hex);if(match){for(var channelWidth=(hex=match[1]).length>=6?2:1,channelCount=hex.length/channelWidth,scale=1==channelWidth?1/15:1/255,channels=[],i=0;i<channelCount;i++){var _int=parseInt(hex.substr(i*channelWidth,channelWidth),16);channels.push(_int*scale)}return 3==channelCount&&channels.push(1),"rgba("+channels.slice(0,3).map(function(x){return String(Math.round(255*x))}).join(",")+","+String(Number(channels[3].toFixed(3)))+")"}},function(color){var s=(new Option).style;return s.color=color,s.color?color:void 0}];Prism.hooks.add("wrap",function(env){if("color"===env.type||env.classes.indexOf("color")>=0){for(var color,content=env.content,rawText=content.split(HTML_TAG).join(""),i=0,l=parsers.length;i<l&&!color;i++)color=parsers[i](rawText);if(!color)return;var previewElement='<span class="inline-color-wrapper"><span class="inline-color" style="background-color:'+color+';"></span></span>';env.content=previewElement+content}})}}()},{}],16:[function(require,module,exports){"use strict";!function(){if("undefined"!=typeof Prism&&"undefined"!=typeof document){var NEW_LINE_EXP=/\n(?!$)/g,config=Prism.plugins.lineNumbers={getLine:function(element,number){if("PRE"===element.tagName&&element.classList.contains("line-numbers")){var lineNumberRows=element.querySelector(".line-numbers-rows");if(lineNumberRows){var lineNumberStart=parseInt(element.getAttribute("data-start"),10)||1,lineNumberEnd=lineNumberStart+(lineNumberRows.children.length-1);number<lineNumberStart&&(number=lineNumberStart),number>lineNumberEnd&&(number=lineNumberEnd);var lineIndex=number-lineNumberStart;return lineNumberRows.children[lineIndex]}}},resize:function(element){resizeElements([element])},assumeViewportIndependence:!0},lastWidth=void 0;window.addEventListener("resize",function(){config.assumeViewportIndependence&&lastWidth===window.innerWidth||(lastWidth=window.innerWidth,resizeElements(Array.prototype.slice.call(document.querySelectorAll("pre.line-numbers"))))}),Prism.hooks.add("complete",function(env){if(env.code){var code=env.element,pre=code.parentNode;if(pre&&/pre/i.test(pre.nodeName)&&!code.querySelector(".line-numbers-rows")&&Prism.util.isActive(code,"line-numbers")){code.classList.remove("line-numbers"),pre.classList.add("line-numbers");var lineNumbersWrapper,match=env.code.match(NEW_LINE_EXP),linesNum=match?match.length+1:1,lines=new Array(linesNum+1).join("<span></span>");(lineNumbersWrapper=document.createElement("span")).setAttribute("aria-hidden","true"),lineNumbersWrapper.className="line-numbers-rows",lineNumbersWrapper.innerHTML=lines,pre.hasAttribute("data-start")&&(pre.style.counterReset="linenumber "+(parseInt(pre.getAttribute("data-start"),10)-1)),env.element.appendChild(lineNumbersWrapper),resizeElements([pre]),Prism.hooks.run("line-numbers",env)}}}),Prism.hooks.add("line-numbers",function(env){env.plugins=env.plugins||{},env.plugins.lineNumbers=!0})}function resizeElements(elements){if(0!=(elements=elements.filter(function(e){var whiteSpace=function(element){if(!element)return null;return window.getComputedStyle?getComputedStyle(element):element.currentStyle||null}(e)["white-space"];return"pre-wrap"===whiteSpace||"pre-line"===whiteSpace})).length){var infos=elements.map(function(element){var codeElement=element.querySelector("code"),lineNumbersWrapper=element.querySelector(".line-numbers-rows");if(codeElement&&lineNumbersWrapper){var lineNumberSizer=element.querySelector(".line-numbers-sizer"),codeLines=codeElement.textContent.split(NEW_LINE_EXP);lineNumberSizer||((lineNumberSizer=document.createElement("span")).className="line-numbers-sizer",codeElement.appendChild(lineNumberSizer)),lineNumberSizer.innerHTML="0",lineNumberSizer.style.display="block";var oneLinerHeight=lineNumberSizer.getBoundingClientRect().height;return lineNumberSizer.innerHTML="",{element:element,lines:codeLines,lineHeights:[],oneLinerHeight:oneLinerHeight,sizer:lineNumberSizer}}}).filter(Boolean);infos.forEach(function(info){var lineNumberSizer=info.sizer,lines=info.lines,lineHeights=info.lineHeights,oneLinerHeight=info.oneLinerHeight;lineHeights[lines.length-1]=void 0,lines.forEach(function(line,index){if(line&&line.length>1){var e=lineNumberSizer.appendChild(document.createElement("span"));e.style.display="block",e.textContent=line}else lineHeights[index]=oneLinerHeight})}),infos.forEach(function(info){for(var lineNumberSizer=info.sizer,lineHeights=info.lineHeights,childIndex=0,i=0;i<lineHeights.length;i++)void 0===lineHeights[i]&&(lineHeights[i]=lineNumberSizer.children[childIndex++].getBoundingClientRect().height)}),infos.forEach(function(info){var lineNumberSizer=info.sizer,wrapper=info.element.querySelector(".line-numbers-rows");lineNumberSizer.style.display="none",lineNumberSizer.innerHTML="",info.lineHeights.forEach(function(height,lineNumber){wrapper.children[lineNumber].style.height=height+"px"})})}}}()},{}],17:[function(require,module,exports){"use strict";!function(){if("undefined"!=typeof Prism&&"undefined"!=typeof document){var PARTNER={"(":")","[":"]","{":"}"},NAMES={"(":"brace-round","[":"brace-square","{":"brace-curly"},BRACE_ALIAS_MAP={"${":"{"},pairIdCounter=0,BRACE_ID_PATTERN=/^(pair-\d+-)(close|open)$/;Prism.hooks.add("complete",function(env){var code=env.element,pre=code.parentElement;if(pre&&"PRE"==pre.tagName){var toMatch=[];if(Prism.util.isActive(code,"match-braces")&&toMatch.push("(","[","{"),0!=toMatch.length){pre.__listenerAdded||(pre.addEventListener("mousedown",function(){var code=pre.querySelector("code"),className=mapClassName("brace-selected");Array.prototype.slice.call(code.querySelectorAll("."+className)).forEach(function(e){e.classList.remove(className)})}),Object.defineProperty(pre,"__listenerAdded",{value:!0}));var punctuation=Array.prototype.slice.call(code.querySelectorAll("span."+mapClassName("token")+"."+mapClassName("punctuation"))),allBraces=[];toMatch.forEach(function(open){for(var close=PARTNER[open],name=mapClassName(NAMES[open]),pairs=[],openStack=[],i=0;i<punctuation.length;i++){var element=punctuation[i];if(0==element.childElementCount){var text=element.textContent;(text=BRACE_ALIAS_MAP[text]||text)===open?(allBraces.push({index:i,open:!0,element:element}),element.classList.add(name),element.classList.add(mapClassName("brace-open")),openStack.push(i)):text===close&&(allBraces.push({index:i,open:!1,element:element}),element.classList.add(name),element.classList.add(mapClassName("brace-close")),openStack.length&&pairs.push([i,openStack.pop()]))}}pairs.forEach(function(pair){var pairId="pair-"+pairIdCounter+++"-",opening=punctuation[pair[0]],closing=punctuation[pair[1]];opening.id=pairId+"open",closing.id=pairId+"close",[opening,closing].forEach(function(e){e.addEventListener("mouseenter",hoverBrace),e.addEventListener("mouseleave",leaveBrace),e.addEventListener("click",clickBrace)})})});var level=0;allBraces.sort(function(a,b){return a.index-b.index}),allBraces.forEach(function(brace){brace.open?(brace.element.classList.add(mapClassName("brace-level-"+(level%12+1))),level++):(level=Math.max(0,level-1),brace.element.classList.add(mapClassName("brace-level-"+(level%12+1))))})}}})}function mapClassName(name){var customClass=Prism.plugins.customClass;return customClass?customClass.apply(name,"none"):name}function getPartnerBrace(brace){var match=BRACE_ID_PATTERN.exec(brace.id);return document.querySelector("#"+match[1]+("open"==match[2]?"close":"open"))}function hoverBrace(){Prism.util.isActive(this,"brace-hover",!0)&&[this,getPartnerBrace(this)].forEach(function(e){e.classList.add(mapClassName("brace-hover"))})}function leaveBrace(){[this,getPartnerBrace(this)].forEach(function(e){e.classList.remove(mapClassName("brace-hover"))})}function clickBrace(){Prism.util.isActive(this,"brace-select",!0)&&[this,getPartnerBrace(this)].forEach(function(e){e.classList.add(mapClassName("brace-selected"))})}}()},{}],18:[function(require,module,exports){"use strict";!function(){if("undefined"!=typeof Prism&&"undefined"!=typeof document)if(Prism.plugins.toolbar){var Languages={none:"Plain text",plain:"Plain text",plaintext:"Plain text",text:"Plain text",txt:"Plain text",html:"HTML",xml:"XML",svg:"SVG",mathml:"MathML",ssml:"SSML",rss:"RSS",css:"CSS",clike:"C-like",js:"JavaScript",abap:"ABAP",abnf:"ABNF",al:"AL",antlr4:"ANTLR4",g4:"ANTLR4",apacheconf:"Apache Configuration",apl:"APL",aql:"AQL",ino:"Arduino",arff:"ARFF",armasm:"ARM Assembly","arm-asm":"ARM Assembly",art:"Arturo",asciidoc:"AsciiDoc",adoc:"AsciiDoc",aspnet:"ASP.NET (C#)",asm6502:"6502 Assembly",asmatmel:"Atmel AVR Assembly",autohotkey:"AutoHotkey",autoit:"AutoIt",avisynth:"AviSynth",avs:"AviSynth","avro-idl":"Avro IDL",avdl:"Avro IDL",awk:"AWK",gawk:"GAWK",sh:"Shell",basic:"BASIC",bbcode:"BBcode",bbj:"BBj",bnf:"BNF",rbnf:"RBNF",bqn:"BQN",bsl:"BSL (1C:Enterprise)",oscript:"OneScript",csharp:"C#",cs:"C#",dotnet:"C#",cpp:"C++",cfscript:"CFScript",cfc:"CFScript",cil:"CIL",cilkc:"Cilk/C","cilk-c":"Cilk/C",cilkcpp:"Cilk/C++","cilk-cpp":"Cilk/C++",cilk:"Cilk/C++",cmake:"CMake",cobol:"COBOL",coffee:"CoffeeScript",conc:"Concurnas",csp:"Content-Security-Policy","css-extras":"CSS Extras",csv:"CSV",cue:"CUE",dataweave:"DataWeave",dax:"DAX",django:"Django/Jinja2",jinja2:"Django/Jinja2","dns-zone-file":"DNS zone file","dns-zone":"DNS zone file",dockerfile:"Docker",dot:"DOT (Graphviz)",gv:"DOT (Graphviz)",ebnf:"EBNF",editorconfig:"EditorConfig",ejs:"EJS",etlua:"Embedded Lua templating",erb:"ERB","excel-formula":"Excel Formula",xlsx:"Excel Formula",xls:"Excel Formula",fsharp:"F#","firestore-security-rules":"Firestore security rules",ftl:"FreeMarker Template Language",gml:"GameMaker Language",gamemakerlanguage:"GameMaker Language",gap:"GAP (CAS)",gcode:"G-code",gdscript:"GDScript",gedcom:"GEDCOM",gettext:"gettext",po:"gettext",glsl:"GLSL",gn:"GN",gni:"GN","linker-script":"GNU Linker Script",ld:"GNU Linker Script","go-module":"Go module","go-mod":"Go module",graphql:"GraphQL",hbs:"Handlebars",hs:"Haskell",hcl:"HCL",hlsl:"HLSL",http:"HTTP",hpkp:"HTTP Public-Key-Pins",hsts:"HTTP Strict-Transport-Security",ichigojam:"IchigoJam","icu-message-format":"ICU Message Format",idr:"Idris",ignore:".ignore",gitignore:".gitignore",hgignore:".hgignore",npmignore:".npmignore",inform7:"Inform 7",javadoc:"JavaDoc",javadoclike:"JavaDoc-like",javastacktrace:"Java stack trace",jq:"JQ",jsdoc:"JSDoc","js-extras":"JS Extras",json:"JSON",webmanifest:"Web App Manifest",json5:"JSON5",jsonp:"JSONP",jsstacktrace:"JS stack trace","js-templates":"JS Templates",keepalived:"Keepalived Configure",kts:"Kotlin Script",kt:"Kotlin",kumir:"KuMir (КуМир)",kum:"KuMir (КуМир)",latex:"LaTeX",tex:"TeX",context:"ConTeXt",lilypond:"LilyPond",ly:"LilyPond",emacs:"Lisp",elisp:"Lisp","emacs-lisp":"Lisp",llvm:"LLVM IR",log:"Log file",lolcode:"LOLCODE",magma:"Magma (CAS)",md:"Markdown","markup-templating":"Markup templating",matlab:"MATLAB",maxscript:"MAXScript",mel:"MEL",metafont:"METAFONT",mongodb:"MongoDB",moon:"MoonScript",n1ql:"N1QL",n4js:"N4JS",n4jsd:"N4JS","nand2tetris-hdl":"Nand To Tetris HDL",naniscript:"Naninovel Script",nani:"Naninovel Script",nasm:"NASM",neon:"NEON",nginx:"nginx",nsis:"NSIS",objectivec:"Objective-C",objc:"Objective-C",ocaml:"OCaml",opencl:"OpenCL",openqasm:"OpenQasm",qasm:"OpenQasm",parigp:"PARI/GP",objectpascal:"Object Pascal",psl:"PATROL Scripting Language",pcaxis:"PC-Axis",px:"PC-Axis",peoplecode:"PeopleCode",pcode:"PeopleCode",php:"PHP",phpdoc:"PHPDoc","php-extras":"PHP Extras","plant-uml":"PlantUML",plantuml:"PlantUML",plsql:"PL/SQL",powerquery:"PowerQuery",pq:"PowerQuery",mscript:"PowerQuery",powershell:"PowerShell",promql:"PromQL",properties:".properties",protobuf:"Protocol Buffers",purebasic:"PureBasic",pbfasm:"PureBasic",purs:"PureScript",py:"Python",qsharp:"Q#",qs:"Q#",q:"Q (kdb+ database)",qml:"QML",rkt:"Racket",cshtml:"Razor C#",razor:"Razor C#",jsx:"React JSX",tsx:"React TSX",renpy:"Ren'py",rpy:"Ren'py",res:"ReScript",rest:"reST (reStructuredText)",robotframework:"Robot Framework",robot:"Robot Framework",rb:"Ruby",sas:"SAS",sass:"Sass (Sass)",scss:"Sass (SCSS)","shell-session":"Shell session","sh-session":"Shell session",shellsession:"Shell session",sml:"SML",smlnj:"SML/NJ",solidity:"Solidity (Ethereum)",sol:"Solidity (Ethereum)","solution-file":"Solution file",sln:"Solution file",soy:"Soy (Closure Template)",sparql:"SPARQL",rq:"SPARQL","splunk-spl":"Splunk SPL",sqf:"SQF: Status Quo Function (Arma 3)",sql:"SQL",stata:"Stata Ado",iecst:"Structured Text (IEC 61131-3)",supercollider:"SuperCollider",sclang:"SuperCollider",systemd:"Systemd configuration file","t4-templating":"T4 templating","t4-cs":"T4 Text Templates (C#)",t4:"T4 Text Templates (C#)","t4-vb":"T4 Text Templates (VB)",tap:"TAP",tt2:"Template Toolkit 2",toml:"TOML",trickle:"trickle",troy:"troy",trig:"TriG",ts:"TypeScript",tsconfig:"TSConfig",uscript:"UnrealScript",uc:"UnrealScript",uorazor:"UO Razor Script",uri:"URI",url:"URL",vbnet:"VB.Net",vhdl:"VHDL",vim:"vim","visual-basic":"Visual Basic",vba:"VBA",vb:"Visual Basic",wasm:"WebAssembly","web-idl":"Web IDL",webidl:"Web IDL",wgsl:"WGSL",wiki:"Wiki markup",wolfram:"Wolfram language",nb:"Mathematica Notebook",wl:"Wolfram language",xeoracube:"XeoraCube","xml-doc":"XML doc (.net)",xojo:"Xojo (REALbasic)",xquery:"XQuery",yaml:"YAML",yml:"YAML",yang:"YANG"};Prism.plugins.toolbar.registerButton("show-language",function(env){var pre=env.element.parentNode;if(pre&&/pre/i.test(pre.nodeName)){var id,language=pre.getAttribute("data-language")||Languages[env.language]||((id=env.language)?(id.substring(0,1).toUpperCase()+id.substring(1)).replace(/s(?=cript)/,"S"):id);if(language){var element=document.createElement("span");return element.textContent=language,element}}})}else console.warn("Show Languages plugin loaded before Toolbar plugin.")}()},{}],19:[function(require,module,exports){"use strict";!function(){if("undefined"!=typeof Prism&&"undefined"!=typeof document){var callbacks=[],map={},noop=function(){};Prism.plugins.toolbar={};var registerButton=Prism.plugins.toolbar.registerButton=function(key,opts){var callback;callback="function"==typeof opts?opts:function(env){var element;return"function"==typeof opts.onClick?((element=document.createElement("button")).type="button",element.addEventListener("click",function(){opts.onClick.call(this,env)})):"string"==typeof opts.url?(element=document.createElement("a")).href=opts.url:element=document.createElement("span"),opts.className&&element.classList.add(opts.className),element.textContent=opts.text,element},key in map?console.warn('There is a button with the key "'+key+'" registered already.'):callbacks.push(map[key]=callback)},hook=Prism.plugins.toolbar.hook=function(env){var pre=env.element.parentNode;if(pre&&/pre/i.test(pre.nodeName)&&!pre.parentNode.classList.contains("code-toolbar")){var wrapper=document.createElement("div");wrapper.classList.add("code-toolbar"),pre.parentNode.insertBefore(wrapper,pre),wrapper.appendChild(pre);var toolbar=document.createElement("div");toolbar.classList.add("toolbar");var elementCallbacks=callbacks,order=function(element){for(;element;){var order=element.getAttribute("data-toolbar-order");if(null!=order)return(order=order.trim()).length?order.split(/\s*,\s*/g):[];element=element.parentElement}}(env.element);order&&(elementCallbacks=order.map(function(key){return map[key]||noop})),elementCallbacks.forEach(function(callback){var element=callback(env);if(element){var item=document.createElement("div");item.classList.add("toolbar-item"),item.appendChild(element),toolbar.appendChild(item)}}),wrapper.appendChild(toolbar)}};registerButton("label",function(env){var pre=env.element.parentNode;if(pre&&/pre/i.test(pre.nodeName)&&pre.hasAttribute("data-label")){var element,template,text=pre.getAttribute("data-label");try{template=document.querySelector("template#"+text)}catch(e){}return template?element=template.content:(pre.hasAttribute("data-url")?(element=document.createElement("a")).href=pre.getAttribute("data-url"):element=document.createElement("span"),element.textContent=text),element}}),Prism.hooks.add("complete",hook)}}()},{}],20:[function(require,module,exports){"use strict";"undefined"!=typeof Prism&&(Prism.languages.treeview={"treeview-part":{pattern:/^.+/m,inside:{"entry-line":[{pattern:/\|-- |├── /,alias:"line-h"},{pattern:/\| {3}|│ {3}/,alias:"line-v"},{pattern:/`-- |└── /,alias:"line-v-last"},{pattern:/ {4}/,alias:"line-v-gap"}],"entry-name":{pattern:/.*\S.*/,inside:{operator:/ -> /}}}}},Prism.hooks.add("wrap",function(env){if("treeview"===env.language&&"entry-name"===env.type){var classes=env.classes,folderPattern=/(^|[^\\])\/\s*$/;if(folderPattern.test(env.content))env.content=env.content.replace(folderPattern,"$1"),classes.push("dir");else{env.content=env.content.replace(/(^|[^\\])[=*|]\s*$/,"$1");for(var parts=env.content.toLowerCase().replace(/\s+/g,"").split(".");parts.length>1;)parts.shift(),classes.push("ext-"+parts.join("-"))}"."===env.content[0]&&classes.push("dotfile")}}))},{}],21:[function(require,module,exports){"use strict";require("./_main/prism.js"),require("./_language/prism-markup.js"),require("./_language/prism-css.js"),require("./_language/prism-css-extras.js"),require("./_language/prism-bash.js"),require("./_language/prism-clike.js"),require("./_language/prism-javascript.js"),require("./_language/prism-json.js"),require("./_language/prism-sass.js"),require("./_language/prism-scss.js"),require("./_language/prism-powershell.js"),require("./_plugin/prism-autolinker.js"),require("./_plugin/prism-toolbar.js"),require("./_plugin/prism-copy-to-clipboard.js"),require("./_plugin/prism-data-uri-highlight.js"),require("./_plugin/prism-inline-color.js"),require("./_plugin/prism-line-numbers.js"),require("./_plugin/prism-match-braces.js"),require("./_plugin/prism-show-language.js"),require("./_plugin/prism-treeview.js")},{"./_language/prism-bash.js":1,"./_language/prism-clike.js":2,"./_language/prism-css-extras.js":3,"./_language/prism-css.js":4,"./_language/prism-javascript.js":5,"./_language/prism-json.js":6,"./_language/prism-markup.js":7,"./_language/prism-powershell.js":8,"./_language/prism-sass.js":9,"./_language/prism-scss.js":10,"./_main/prism.js":11,"./_plugin/prism-autolinker.js":12,"./_plugin/prism-copy-to-clipboard.js":13,"./_plugin/prism-data-uri-highlight.js":14,"./_plugin/prism-inline-color.js":15,"./_plugin/prism-line-numbers.js":16,"./_plugin/prism-match-braces.js":17,"./_plugin/prism-show-language.js":18,"./_plugin/prism-toolbar.js":19,"./_plugin/prism-treeview.js":20}]},{},[21]);/* Built with Synticore Website Compiler 1.1.5 */
